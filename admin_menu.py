...
button1 = tk.Button(root, text="Bildirimler", font=("Arial", 20), command=open_cameras)
button1.place(x=1700, y=100, width=150, height=50)

button2 = tk.Button(root, text="Personel Listesi", font=("Arial", 20), command=open_personnel_list)
button2.place(x=1150, y=300, width=250, height=250)  # Sol üst buton

button3 = tk.Button(root, text="Kayıtlar", font=("Arial", 20), command=open_records)
button3.place(x=1450, y=300, width=250, height=250)  # Sağ alt buton
